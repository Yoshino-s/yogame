...
export default class LinkedList<T> {
     ...
     * @private
     */
    public firstNode: LinkedListNode<T> | null = null;
    /**
    ...
    remove(item: T, equalsFunction?: util.IEqualsFunction<T>): boolean {
      ...
      let currentNode: LinkedListNode<T> | null = this.firstNode;
     ...
     * @private
     */
    private equalsAux(n1: LinkedListNode<T> | null, n2: LinkedListNode<T> | null, eqF: util.IEqualsFunction<T>): boolean {
    ...
    reverse(): void {
      let previous: LinkedListNode<T> | null = null;
      let current: LinkedListNode<T> | null = this.firstNode;
