 ...
 */
class LinkedDictionaryPair<K, V> implements DictionaryPair<K, V> {
 ...
 */
class HeadOrTailLinkedDictionaryPair<K, V> implements DictionaryPair<null, null> {
    prev!: LinkedDictionaryPair<K, V> | HeadOrTailLinkedDictionaryPair<K, V>;
    next!: LinkedDictionaryPair<K, V> | HeadOrTailLinkedDictionaryPair<K, V>;
    key = null;
    value = null;
...
function isHeadOrTailLinkedDictionaryPair<K, V>(p: HeadOrTailLinkedDictionaryPair<K, V> | LinkedDictionaryPair<K, V>): p is HeadOrTailLinkedDictionaryPair<K, V> {
  return !p.next;
}
...
export default class LinkedDictionary<K, V> extends Dictionary<K, V> {
     ...
     * to the end.
     */
    private appendToTail(entry: LinkedDictionaryPair<K, V>): void {
